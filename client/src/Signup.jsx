      ...
      <div className="login-container">
        <div className="login-card">
          <div className="logo-container">
            ...
            <h1 className="logo-title">Check your email</h1>
            <p className="welcome-text">We sent a confirmation link to</p>
            <p style={{ color: '#a78bfa', fontWeight: 600, margin: '0.25rem 0 1rem', fontSize: '0.9rem' }}>{email}</p>
          </div>
          <div className="auth-success">
            ✓ Account created! Click the link in your email to activate it, then sign in.
          </div>
